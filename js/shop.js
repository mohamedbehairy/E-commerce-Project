    ...
    for (let i = 0; i < finalRes.data.length; i++) {
      ...
      cartona += `        
        <div class="col-md-3 col-sm-4 col-6 position-relative walid">          
          <div class="item border BXShadow" data-product-id="${
            product.id
          }">            
            <div class="image position-relative my-3 cursor-pointer" onclick="redirectToProductDetails('${
              product.id
            }')">              
        ...
        product.discount ? `-${product.discount}%` : ""
            ...
            <div class="img-info text-center">              
              ...
              <div class="price d-flex justify-content-between flex-column ">                
                ...
                <a class="pro_name mb-2 cursor-pointer hover-blue fw-medium" onclick="redirectToProductDetails('${
                  product.id
                }')">${product.title
        .split(" ")
        .slice(0, 2)
